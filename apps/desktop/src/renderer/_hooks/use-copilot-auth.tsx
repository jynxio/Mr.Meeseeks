...
const fsm = setup({
    ...
    actors: {
        cancelOrSignOut: fromPromise(() => ipcInvoker["copilot-auth:cancel-or-sign-out"]()),
        retrieveUserCode: fromPromise(() => ipcInvoker["copilot-auth:retrieve-user-code"]()),
        validateUserCode: fromPromise(() => ipcInvoker["copilot-auth:validate-user-code"]()),
    },
}).createMachine({
    context: {},
    initial: "idle",
